...
import minestrapp.entity.model.ModelMBoat;
...
public class RenderMBoat extends Render<EntityMBoat>
{
    ...
    public void doRender(EntityMBoat entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.modelMBoat.render(entity, partialTicks, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
    ...
    public void setupRotation(EntityMBoat p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityMBoat entity)
    {
        return BOAT_TEXTURES[entity.getMBoatType().ordinal()];
    }
    ...
    public void renderMultipass(EntityMBoat p_188300_1_, double p_188300_2_, double p_188300_4_, double p_188300_6_, float p_188300_8_, float p_188300_9_)
    {
        GlStateManager.pushMatrix();
        ...
        ((IMultipassModel)this.modelMBoat).renderMultipass(p_188300_1_, p_188300_9_, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
        GlStateManager.popMatrix();
    }
}