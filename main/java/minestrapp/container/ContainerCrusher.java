...
import minestrapp.crafting.SlotCrusherFuel;
import minestrapp.crafting.SlotCrusherOutput;
...
public class ContainerCrusher extends Container {
	...
	private final TileEntityCrusher te;
	...
	public ContainerCrusher(InventoryPlayer player, TileEntityCrusher tileentity) {
		...
		this.addSlotToContainer(new SlotCrusherOutput(player.player, tileentity, 2, 116, 25));
		this.addSlotToContainer(new SlotCrusherOutput(player.player, tileentity, 3, 116, 49));
	...
	public TileEntityCrusher getTE(){
		return te;
