			                ...
			                if (xOffset * xOffset + zOffset * zOffset <= radius * radius)
			                {
			                	...
			                	if(generate)
			                	{
			                		if(layer == 0 || world.getBlockState(new BlockPos(x, pos.getY() + layer - 2, z)).getBlock() == MBlocks.desert_quartz_deposit)
			                		{
			                			...
			                			else if(world.getBlockState(placePos.offset(EnumFacing.NORTH)) == Blocks.SAND.getDefaultState().withProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND) || world.getBlockState(placePos.offset(EnumFacing.NORTH)).getBlock() == Blocks.RED_SANDSTONE || world.getBlockState(placePos.offset(EnumFacing.EAST)) == Blocks.SAND.getDefaultState().withProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND) || world.getBlockState(placePos.offset(EnumFacing.EAST)).getBlock() == Blocks.RED_SANDSTONE || world.getBlockState(placePos.offset(EnumFacing.SOUTH)) == Blocks.SAND.getDefaultState().withProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND) || world.getBlockState(placePos.offset(EnumFacing.SOUTH)).getBlock() == Blocks.RED_SANDSTONE || world.getBlockState(placePos.offset(EnumFacing.WEST)) == Blocks.SAND.getDefaultState().withProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND) || world.getBlockState(placePos.offset(EnumFacing.WEST)).getBlock() == Blocks.RED_SANDSTONE)
