...
public class FreezingRecipes
{
	...
	private FreezingRecipes()
	{
		...
		this.addLightFreezingRecipe(new ItemStack(Blocks.DIRT, 1, 0), new ItemStack(MBlocks.permafrost, 1, 0));
		this.addLightFreezingRecipe(new ItemStack(Blocks.DIRT, 1, 1), new ItemStack(MBlocks.permafrost, 1, 1));
		this.addLightFreezingRecipe(new ItemStack(Blocks.DIRT, 1, 2), new ItemStack(MBlocks.permafrost, 1, 2));
		this.addLightFreezingRecipe(new ItemStack(Blocks.GRASS), new ItemStack(MBlocks.lichen));
		this.addLightFreezingRecipe(new ItemStack(Blocks.MYCELIUM), new ItemStack(MBlocks.lichen));
		this.addLightFreezingRecipe(new ItemStack(Blocks.GRASS_PATH), new ItemStack(MBlocks.permafrost));
		this.addLightFreezingRecipe(new ItemStack(Blocks.FARMLAND, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(MBlocks.permafrost));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.clay_soil, 1, 0), new ItemStack(MBlocks.permafrost, 1, 0));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.clay_soil, 1, 1), new ItemStack(MBlocks.permafrost, 1, 1));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.clay_soil, 1, 2), new ItemStack(MBlocks.permafrost, 1, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.clay_grass), new ItemStack(MBlocks.lichen));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.clay_grass_path), new ItemStack(MBlocks.permafrost));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.clay_farmland, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(MBlocks.permafrost));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.mud), new ItemStack(MBlocks.permafrost));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.dried_mud), new ItemStack(MBlocks.cold_sand));
		...
		this.addLightFreezingRecipe(new ItemStack(Blocks.LEAVES, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.SNOW));
		this.addLightFreezingRecipe(new ItemStack(Blocks.LEAVES2, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.SNOW));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.cobblestone, 1, 5), new ItemStack(MBlocks.mossy_cobblestone, 1, 5));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.cobblestone, 1, 6), new ItemStack(MBlocks.mossy_cobblestone, 1, 6));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.stone_bricks, 1, 5), new ItemStack(MBlocks.mossy_stone_bricks, 1, 5));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.stone_bricks, 1, 6), new ItemStack(MBlocks.mossy_stone_bricks, 1, 6));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.cracked_stone_bricks, 1, 5), new ItemStack(MBlocks.mossy_stone_bricks, 1, 5));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.cracked_stone_bricks, 1, 6), new ItemStack(MBlocks.mossy_stone_bricks, 1, 6));
		this.addLightFreezingRecipe(new ItemStack(Blocks.BEETROOTS, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(Blocks.WHEAT, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(Blocks.CARROTS, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(Blocks.POTATOES, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(Blocks.PUMPKIN_STEM, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(Blocks.MELON_STEM, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_cabbage, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_celery, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_corn, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_lettuce, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_onion, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_peanuts, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_pepper, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_tomato, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.crop_withered, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(Blocks.COCOA, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 3));
		this.addLightFreezingRecipe(new ItemStack(Blocks.DEADBUSH, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(Blocks.TALLGRASS, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 2));
		this.addLightFreezingRecipe(new ItemStack(Blocks.DOUBLE_PLANT, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 4));
		this.addLightFreezingRecipe(new ItemStack(Blocks.WATERLILY, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(Blocks.SAPLING, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 4));
		this.addLightFreezingRecipe(new ItemStack(Blocks.REEDS, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 4));
		this.addLightFreezingRecipe(new ItemStack(Blocks.VINE, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(Blocks.RED_FLOWER, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(Blocks.YELLOW_FLOWER, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.moss), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(Blocks.RED_MUSHROOM), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(Blocks.BROWN_MUSHROOM), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.purple_glowshroom), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.green_glowshroom), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.blue_glowshroom), new ItemStack(Items.SNOWBALL, 1));
		this.addLightFreezingRecipe(new ItemStack(MBlocks.savanna_grass, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Items.SNOWBALL, 3));
		
		//Deep Freezing Recipes
		this.addDeepFreezingRecipe(new ItemStack(Blocks.WATER, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.FLOWING_WATER, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.LAVA, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.OBSIDIAN));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.FLOWING_LAVA, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.MAGMA));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.PACKED_ICE), new ItemStack(MBlocks.glacieric_ice));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.SNOW), new ItemStack(Blocks.PACKED_ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.NETHERRACK), new ItemStack(MBlocks.stone, 1, 1));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.MAGMA), new ItemStack(Blocks.OBSIDIAN));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.CACTUS), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.LEAVES, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.LEAVES2, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.MELON_BLOCK), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.PUMPKIN, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.LIT_PUMPKIN, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.pumpkin_normie, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.pumpkin_smiley, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.pumpkin_creepy, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.pumpkin_dumpy, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.pumpkin_grumpy, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.pumpkin_smashed, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.RED_MUSHROOM_BLOCK, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.BROWN_MUSHROOM_BLOCK, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.blue_glowshroom_block, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.green_glowshroom_block, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.purple_glowshroom_block, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.ICE));
		for(int k = 0 ; k < 6 ; k++)
		{
			this.addDeepFreezingRecipe(new ItemStack(MBlocks.bauble_glowshroom_blue, 1, k), new ItemStack(MBlocks.bauble_ice, 1, k));
			this.addDeepFreezingRecipe(new ItemStack(MBlocks.bauble_glowshroom_purple, 1, k), new ItemStack(MBlocks.bauble_ice, 1, k));
			this.addDeepFreezingRecipe(new ItemStack(MBlocks.bauble_glowshroom_green, 1, k), new ItemStack(MBlocks.bauble_ice, 1, k));
		}
		this.addDeepFreezingRecipe(new ItemStack(Blocks.HAY_BLOCK, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.SNOW));
		this.addDeepFreezingRecipe(new ItemStack(Blocks.REDSTONE_BLOCK), new ItemStack(MBlocks.block_redstone_frosted_lit));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.block_redstone_frosted_lit), new ItemStack(MBlocks.block_redstone_icy_lit));
		this.addDeepFreezingRecipe(new ItemStack(MBlocks.block_redstone_frosted_unlit), new ItemStack(MBlocks.block_redstone_icy_unlit));
	}
	...
	public void addLightFreezingRecipe(ItemStack input1, ItemStack result)
	{
		this.lightFreezing.put(input1, result);
	}
	
	public void addDeepFreezingRecipe(ItemStack input1, ItemStack result)
	{
	...
	public Map<ItemStack, ItemStack> getLightFreezingList()
    {
        return this.lightFreezing;
    }
	
	public Map<ItemStack, ItemStack> getDeepFreezingList()
    {
