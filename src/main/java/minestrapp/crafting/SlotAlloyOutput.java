...
public class SlotAlloyOutput extends Slot{
	...
	public SlotAlloyOutput(EntityPlayer player, IInventory inventoryIn, int index, int xPosition, int yPosition) {
	...
	protected void onCrafting(ItemStack stack) {
		...
		if(!this.player.world.isRemote) {
			...
			float f = AlloyRecipes.instance().getAlloyExperience(stack);
