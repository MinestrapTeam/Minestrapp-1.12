...
public class ModelMBoat extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityMBoat entityMboat = (EntityMBoat)entityIn;
        ...
        this.renderPaddle(entityMboat, 0, scale, limbSwing);
        this.renderPaddle(entityMboat, 1, scale, limbSwing);
    }
    ...
    protected void renderPaddle(EntityMBoat boat, int paddle, float scale, float limbSwing)
    {
